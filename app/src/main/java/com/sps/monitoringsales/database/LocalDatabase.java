...
import com.sps.monitoringsales.database.dao.PenilaianKeluhanDao;
 ...
 */
@Database(version = 1, entities = {Outlet.class, Bungkus.class, Hadiah.class, Sales.class, Penukaran.class, PenukaranBungkus.class, PenukaranHadiah.class, Akun.class, Penilaian.class, KeluhanSaran.class}, exportSchema = false)
...
public abstract class LocalDatabase extends RoomDatabase {
    ...
    public abstract PenilaianKeluhanDao getPenilaianKeluhanDAO();
}
